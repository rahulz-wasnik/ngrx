...
import * as productState from './../state/product.state';
...
export class ProductEditComponent implements OnInit, OnDestroy {
  ...
  constructor(private fb: FormBuilder,
              ...
              private store: Store<productState.State>) {
  ...
  ngOnInit(): void {
    ...
    this.store.pipe(select(productStateSelectors.getCurrentProduct), takeWhile(() => this.componentActive)).subscribe(
